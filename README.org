...
#+html:<details>
#+html:<summary><b>Method 1: Install via pi Package Manager (Recommended)</b></summary>
#+html:<br>
...
#+html:<details>
#+html:<summary><b>Method 2: Manual Installation via Git Clone + Package Configuration</b></summary>
#+html:<br>
...
- *slow-mode*: Review gate for =write= and =edit= tool calls
  ...
  *Features:*
  ...
  - Status bar indicator: =slow ■= (active)
...
- *direnv*: Auto-loads environment variables from =.envrc= files
  ...
  *Features:*
  ...
  - Status bar indicator: =direnv …= (loading), =direnv ✓= (loaded), =direnv ✗= (error)
...
- *@marckrenn/pi-sub-core*: Status bar core impl
  [[https://github.com/marckrenn/pi-sub][→ pi-sub upstream]]
