...
Some extensions require third-party packages (e.g., =slow-mode= requires =diff= for proper unified diff generation):
...
This installs packages specified in =slow-mode/package.json=.
